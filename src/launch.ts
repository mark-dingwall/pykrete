...
// ("malformed_tool_call"); this flat-string override fixes it. Scoped to the deepseek/ prefix only.
...
export function launchAttempt(opts: LaunchOptions): Promise<AttemptOutcome> {
  ...
  if (opts.candidate.startsWith("deepseek/")) args.push("-e", FLAT_EDIT_PATH);
